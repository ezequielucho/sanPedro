...
function loadSockets(io, conexion) // Se devuelve data.recordset !!!
{
    ...
    {    
        ...
        socket.on('cargar-ultimo-teclado', (data)=>{
            ...
            conexion.recHit(data.database, 'SELECT Codi as id, NOM as nombre, PREU as precioConIva, TipoIva as tipoIva FROM Article').then(res2=>{
                console.log("articulos son: ", res2)
